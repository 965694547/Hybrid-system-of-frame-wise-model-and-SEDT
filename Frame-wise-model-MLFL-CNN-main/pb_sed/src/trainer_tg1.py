...
import shutil
import sys
from src import data_loader_tg1 as data
from src import model as md
from src import model_PT as md_PT
from src import utils
from src import metricCallback_tg1
from src.Logger import LOG

class trainer(object):
	def __init__(self, task_name, model_name, is_PS, from_exp):
		""""
	...
	def get_metricCallback(self, train_mode):
		...
		"""
		data_loader = self.data_loader
		callback = metricCallback_tg1.metricCallback(self.conf_dir, train_mode)
